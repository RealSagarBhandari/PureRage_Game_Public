...
// So this regular expression matches any string that contains between 1 and 50 alphanumeric characters
const USERNAME_PATTERN = /^[a-zA-Z0-9]{1,50}$/;
...
function loginCallback(response) {
  ...
  function validateLoginForm(event) {
	...
	const request = {
	  ...
	  credentials: "include"  // needed if backend sets cookies and CORS is used
	};
...
function attachEventListeners() {
	...
	loginModal?.addEventListener("hidden.bs.modal", clearForm);
}
